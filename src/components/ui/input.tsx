...
export interface InputProps
  ...
  disableFocus?: boolean; // New prop
}

const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, disableFocus, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          ...
          !disableFocus && "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
          className
        )}
        ref={ref}
        {...props}
